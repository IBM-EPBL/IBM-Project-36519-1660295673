...
app.config['MAIL_PASSWORD'] = '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'
app.config['MAIL_DEFAULT_SENDER'] = 'abitha.thangadurai@gmail.com'

connection=ibm_db.connect("DATABASE=bludb;HOSTNAME=55fbc997-9266-4331-afd3-888b05e734c0.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31929;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=spq76013;PWD=lcAFi0FUxoaVlpTn",'','')
